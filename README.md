...
```
```bash
apt update && apt upgrade && pkg install git nodejs ffmpeg imagemagick yarn && git clone https://github.com/NatixBc/BCBot-MD && cd BCBot-MD && yarn install && npm install && npm start
```
